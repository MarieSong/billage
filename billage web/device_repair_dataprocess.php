<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // SQL 쿼리 실행
        $sql = "INSERT INTO Repair (rp_id, d_id, rp_discover, rp_start, rp_info)
                VALUES ('$repair_id', '$device_id', '$repair_discover', '$repair_start', '$repair_info')";
