...
<body>
    <div class="container">
        ...
        if(isset($_GET['rt_id'])) {
            ...
            $sql_rental = "SELECT d.d_name, d.d_model, d.d_token, d.d_id, rt.u_id, rt_start, rt.rt_state, rt.rt_deadline FROM Rental rt, Device d WHERE rt.d_id = d.d_id AND rt.rt_id = '$rental_id'";
